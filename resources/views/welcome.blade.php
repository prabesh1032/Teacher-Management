...
<div class="max-w-4xl mx-auto text-center py-16 px-6">
    ...
    <div class="space-x-4">
        ...
        <a href="{{ route('subjects.show') }}" class="inline-block border-3 border-indigo-600 text-indigo-600 px-6 py-3 rounded-lg font-semibold hover:bg-indigo-600 hover:text-white transition duration-300">
            View Subjects
        </a>
    </div>
    ...
    <div class="mt-20 grid grid-cols-1 md:grid-cols-3 gap-8 text-left">
        <div class="p-6 bg-white rounded-lg shadow hover:shadow-md transition duration-300">
            <i class="ri-user-line text-indigo-900 text-4xl mb-4"></i>
